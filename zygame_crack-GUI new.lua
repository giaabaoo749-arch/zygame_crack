...
-- // 1. Tạo Giao diện Nhập Key (Key System)
...
-- // 2. Logic kiểm tra và khởi tạo Hub
CheckBtn.MouseButton1Click:Connect(function()
    if InputBox.Text == CORRECT_KEY then
        KeyGui:Destroy() -- Xóa bảng nhập Key
        
        -- // 3. Khởi tạo Venyx Hub sau khi nhập đúng
        ...
        UI:SelectPage(UI.pages[1], true) -- Mở trang đầu tiên
    else
